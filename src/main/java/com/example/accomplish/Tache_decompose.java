...
public class Tache_decompose extends Tache{
    private List<Tache_simple> list_taches;
    private int taux_etat_realisation;

    public Tache_decompose(String tache_name, Priorite tache_priorite, boolean ifdeadline, int deadline, Categorie tache_categorie, boolean tasktype, boolean scheduled, boolean tache_locked, List<Tache_simple> list_taches) {
    ...
    public List<Tache_simple> getList_taches() {
        return list_taches;
    }
