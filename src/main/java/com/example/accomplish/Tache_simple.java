...
public class Tache_simple extends Tache{
    ...
    public Tache_simple(String tache_name, Priorite tache_priorite, boolean ifdeadline, LocalDate deadline, Categorie tache_categorie, boolean tasktype, boolean tache_locked, Peridicite tache_periodicite) {
